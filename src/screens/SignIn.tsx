...
import { Heart, Loader, AlertCircle, Eye, EyeOff, Mail, Lock } from 'lucide-react';
...
export default function SignIn() {
  ...
  const { signIn, signInWithGoogle, error, clearError, isLoading } = useAuth();
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
          ...
          <Link to="/auth/signup" className="primary-text font-bold hover:underline">
            Sign Up
          </Link>
        </motion.div>
