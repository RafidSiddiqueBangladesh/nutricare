...
import { ChevronLeft, Activity, Smile, User, Hand, Video, ChevronRight, Heart, Stethoscope, Watch } from 'lucide-react';
...
export default function TrackingOptions() {
  ...
  const MODULES = [
    ...
    { icon: Watch, label: 'Connect Physical Device', desc: 'Pair a watch or BLE sensor to stream heart rate, glucose, and blood pressure.', path: '/health/monitor/device' },
